package com.example.SERVICE_VOITURE.controlers;

import com.example.SERVICE_VOITURE.ServiceVoitureApplication;
...
public class VoitureController {
    ...
    @Autowired
    Voiture voitureService;

    @Autowired
    ServiceVoitureApplication.Client clientService;
